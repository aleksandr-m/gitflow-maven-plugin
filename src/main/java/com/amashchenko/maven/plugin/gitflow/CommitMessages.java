...
public class CommitMessages {
	...
	private String bugfixFinishDevMergeMessage;
	private String bugfixFinishMessage;
	private String updateBugfixBackMessage;
	private String bugfixStartMessage;
	...
	public CommitMessages() {
		...
		bugfixStartMessage = "Update versions for bugfix branch";
		bugfixFinishMessage = "Update versions for development branch";
	...
	public String getBugfixStartMessage() {
		return bugfixStartMessage;
	}

	public void setBugfixStartMessage(String bugfixStartMessage) {
		this.bugfixStartMessage = bugfixStartMessage;
	}
	 ...
	 * @deprecated Use the correctly spelt updateDevToAvoidConflictsMessage
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * @param updateReleaseToAvoidConflictsMessage
	 *            the updateReleaseToAvoidConflictsMessage to set
	 */
	...
	/**
	 * @param updateReleaseBackPreMergeStateMessage
	 *            the updateReleaseBackPreMergeStateMessage to set
	 */
	...
	/**
	 * @return the bugfixFinishDevMergeMessage
	 */
	public String getBugfixFinishDevMergeMessage() {
		return this.bugfixFinishDevMergeMessage;
	}

	/**
	 * @param bugfixFinishDevMergeMessage
	 *            the bugfixFinishDevMergeMessage to set
	 */
	public void setBugfixFinishDevMergeMessage(String bugfixFinishDevMergeMessage) {
		this.bugfixFinishDevMergeMessage = bugfixFinishDevMergeMessage;
	}
	
	/**
	 * @return the bugfixFinishMessage
	 */
	public String getBugfixFinishMessage() {
		return this.bugfixFinishMessage;
	}

	
	/**
	 * @return the updateBugfixFinishMessage
	 */
	public String getUpdateBugfixBackMessage() {
		return updateBugfixBackMessage;
	}
	
	/**
	 * @param bugfixFinishMessage
	 *            the bugfixFinishMessage to set
	 */	
	public void setBugfixFinishMessage(String bugfixFinishMessage) {
		this.bugfixFinishMessage = bugfixFinishMessage;
	}

	/**
	 * @param updateBugfixBackMessage
	 *            the updateBugfixBackMessage to set
	 */
	public void setUpdateBugfixBackMessage(String updateBugfixBackMessage) {
		this.updateBugfixBackMessage = updateBugfixBackMessage;
	}
